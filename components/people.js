...
export default class PeopleView extends BaseComp {
  ...
  constructor(props){
    ...
    let people = [
        {name:'Mike Hughes',occupation: 'Blockchain Developer'},
        {name: 'Joe Bloggs', occupation: 'Astrophysicist'},
        {name: 'Jane Bloggs', occupation: 'Nurse'}
      ];
  ...
  _renderHeader() {
    return (
      <Text style={styles.plHeader}>PEOPLE</Text>
    )
  }
